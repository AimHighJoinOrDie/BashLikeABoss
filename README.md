...
The ![Nerd Tree]({{https://github.com/AimHighJoinOrDie/BashLikeABoss/blob/master}}/assets/NT.png) is the most useful plugin of all; it allows for easy navigation.  
